...
##############################################
#
#	Ficheiro: devel/funcoesEscrita.r
...
#
#	Função: converteJSON
#	Objectivo: converte Matriz em String JSON
#	Argumentos:	ds - dataset
#			
#			
#	criador: João Milhinhos
#	data: 27-03-2012
...
converteJSON<-function(ds)
{
	#converteJSON<-toJSON(ds)
	converteJSON<-"Já não está tudo louco!\n\n"
}
